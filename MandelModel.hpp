...
protected:
  ...
  struct PrecisionRecord
  {
    ...
    int threadCount;
    using MandelEvaluatorAnyPtr=std::variant<std::nullptr_t, MandelEvaluator<double> *, MandelEvaluator<__float128> *, MandelEvaluator<MandelMath::dd_real> *, MandelEvaluator<MandelMath::dq_real> *, MandelEvaluator<MandelMath::real642> *, MandelEvaluator<MandelMath::number_any> *>;
    MandelEvaluatorAnyPtr *threads_;
